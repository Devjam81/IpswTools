...
%toolbox%\wget -nv -P %appdata%\IpswTools "https://www.dropbox.com/s/6ax4z6t4sbaamwn/tools.zip?dl=0" >> %logme%
echo download ok ...
...
move /y "%temp%\IpswTools\dlipsw" "%UserProfile%\Desktop\dlipsw"

echo move complete to Desktop
...
echo Files origin is in Desktop Press any key to exit ...
